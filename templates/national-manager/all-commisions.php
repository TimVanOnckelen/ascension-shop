			...
			foreach ( $referrals  as $referral ) :
				...
				if(str_replace(' ','',strtolower($old_parent)) != str_replace(' ','',strtolower($parent))){
					...
					if($parent != '') {
                        ...
                        <tr>
                            ...
                            <td></td>
                            <td></td>
                            <td><b><?php _e("Totaal","ascension-shop"); echo '<br />'.$temp_parent; ?> </b>
                            <td><b><?php echo  affwp_currency_filter( affwp_format_amount($sub_total)); ?></b></td>
                        </tr>
                        <?php
                        }
                        ?>
						...
						if($counter > 0){
                            ...
                            <tr>
                                ...
                                <td></td>
                                <td></td>
                                <td><b><?php _e("Totaal","ascension-shop"); ?></b>
                                <td><b><?php echo  affwp_currency_filter( affwp_format_amount($sub_total)); ?></b></td>
                            </tr>
							<?php
						}
                ...
                <tr>
                    <td class="ascension-order-info" data-th="<?php _e( 'Order', 'affiliate-wp' ); ?>">
                        <a target="_blank" href="<?php echo $order->get_view_order_url(); ?>" class="ascension-order-details-hover"># <?php echo $referral->reference; ?></a>
                    </td>
