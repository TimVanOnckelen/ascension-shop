...
<div id="affwp-affiliate-dashboard-referrals" class="affwp-tab-content">
    ...
    if(isset($_GET["client"]) && $_GET["client"] != ''){
        $extra_info .= "Klant: ".$_GET["client"].'<br />';
    }
    ?>
    ...
    <table id="affwp-affiliate-dashboard-referrals" class="affwp-table affwp-table-responsive">
        <thead>
        <tr>
            <th class="referral-amount"><?php _e( 'Order', 'affiliate-wp' ); ?></th>
		...
		<?php endif; ?>
        <tr><td><b><?php _e("Totaal","ascension-shop"); ?></b></td><td>&euro; <?php echo $total_commision; ?></td><td></td><td></td><td></td><td></td></tr>
        </tbody>
    </table>
