...
class CashGateway extends \WC_Payment_Gateway
{

    public function __construct()
    {
        $this->id = "ascension_cash_gateway";
        $this->icon = apply_filters('woocommerce_bacs_icon', '');
        $this->has_fields = false;
        $this->method_title = __('Ascension cash gateway', 'ascension-shop');
        $this->method_description = "A gateway to set as payed cash";
    ...
    public function init_form_fields()
    {
        ...
        $this->form_fields = apply_filters('wc_offline_form_fields', array(
            ...
            'title' => array(
                ...
                'default' => __('Cash betaald door klant', 'ascension-shop'),
                'desc_tip' => true,
            ),
    ...
    public function process_payment($order_id)
    {
        ...
        $this->instructions = __("U hebt de betaling rechstreeks ontvangen van de klant. Zodra wij deze ontvangen hebben, doen wij het nodige.", "ascension-shop");
