...
class OrderMadeForClient extends \WC_Email {
	/**
	...
	public function __construct() {
		...
		$this->id          = 'WC_OrderMadeForClient';
		$this->title       = __( 'Er werd een bestelling voor u gemaakt', 'ascension-shop' );
		$this->description = __( 'Er werd een bestelling voor u gemaakt op Ascension.', 'ascension-shop' );
		// For admin area to let the user know we are sending this email to customers.
		$this->customer_email = true;
		$this->heading        = __( 'Er werd een bestelling voor u gemaakt op Ascension' );
